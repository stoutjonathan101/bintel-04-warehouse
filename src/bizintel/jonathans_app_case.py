...
# THe one cleaned data file for the smart sales project.
SALES_FILE: Final[Path] = Path("data/prepared/sales_data_prepared.csv")
...
def main() -> None:
    ...
    LOG.info("CALL a function to plot daily sales trend........")

    # Convert SaleDate to datetime
    df_sales["SaleDate"] = pd.to_datetime(df_sales["SaleDate"], errors="coerce")

    # Aggregate daily sales
    df_daily = df_sales.groupby("SaleDate")["SaleAmount"].sum().reset_index()
    ...
    LOG.info("========================")
    LOG.info("Jonathans Custom Application Executed successfully!")
    LOG.info("========================")
